...
public class Register extends Activity {
    ...
    public void storeInDB(View v) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS details(name VARCHAR NOT NULL,number VARCHAR UNIQUE) ");
        ...
        {
            Toast.makeText(this, "Invalid Data or Record Already Exist",Toast.LENGTH_SHORT).show();
        }
